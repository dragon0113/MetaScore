# Ex of execution: Rscript 45-1_ExpertCommitteeHighRank_gridSearch_RF_GLM_LDA_ANN_SVM-RBF-LNR_KNN25_NB_PPD_k-fold_CV.R /gpfs/home/yuj114/group/YJ_DOCK_PP/RFBased_ScoringFunction/processed_HADDOCK-Val+interfacialPSSM/Undersampled/ /gpfs/home/yuj114/group/YJ_DOCK_PP/RFBased_ScoringFunction/processed_HADDOCK-Val+interfacialPSSM/ /gpfs/home/yuj114/group/YJ_DOCK_PP/RFBased_ScoringFunction/RF_Result/HADDOCK-Val+interfacialPSSM/10-foldCV/ 10 RF 500 2
# in Hammer server
...
#	test <- as.data.frame(sapply(test, as.numeric)) #result in '?' converted to 1
	...
	test <- test[, c(-1, -3, -6, -7, -16, -17, -18, -19, -20, -21)]                                #All-LowRanks
...
#	final_train <- final_train[, c(-1, -3)]
	...
	final_train <- train[, c(-1, -3, -6, -7, -16, -17, -18, -19, -20, -21)]                                #All-LowRanks
